...
export default function CategoryQuickNav() {
  ...
  // Only keep the full-screen sheet in the DOM while it's open or animating
  // closed — leaving a `fixed inset-0` overlay permanently mounted (even
  // hidden via transform) caused a stray sliver of it to flash into view on
  // real mobile browsers when the address bar collapses/expands during fast
